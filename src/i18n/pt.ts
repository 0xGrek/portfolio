export const pt = {
  ...
  hero_subtitle: 'Especialista em Automação e Sistemas AI. Crio soluções autónomas na interseção de Web3 e inteligência artificial. O background em investigação ensinou-me a ver arquitetura onde outros veem caos.',
  hero_subtitle_lead: 'Especialista em Automação e Sistemas AI. Crio soluções autónomas na interseção de Web3 e inteligência artificial. O background em investigação ensinou-me a ver arquitetura onde outros veem caos.',
  hero_subtitle_body: '',
  hero_bio: '',
  ...
  exp_police_highlights: 'Polícia de Patrulha (2019) → Investigação Criminal (2020) → Unidade Especial (2021)',
  ...
  proj_ton_long: 'Sistema de trading assíncrono multi-agente de nível de produção para o marketplace NFT TON. Construído em Python 3.11, executa 4 instâncias de bot em paralelo (de High-tier (50 TON) a segmentos Entry-level do marketplace), cada uma a gerir um par de contas de trading no Telegram. O sistema utiliza mais de 400 sessões Pyrogram para scanning paralelo do marketplace, integra 6 APIs externas (MRKT, Portal, Gift Satellite, Peek.tg, oráculo xGift, canal Snipes) e implementa estratégias de trading sofisticadas: outbidding com precisão nano-TON, repricing dinâmico em 4 etapas, mecânica cross-rebuy e testes A/B de estratégias. Inclui gestão de risco, backtesting, paper trading, dashboard FastAPI e bot admin aiogram no Telegram. O maior projeto pessoal com 115.000 linhas de código Python.',
