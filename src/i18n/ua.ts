export const ua = {
  // ── Meta ──────────────────────────────────────────────
  meta_title: 'Сергій Іваненко — On-chain аналітик, Web3 дослідник та розробник систем автоматизації.',
  meta_description:
    '0xGrek — Web3 розробник та спеціаліст з блокчейн-розслідувань. 101 інструмент, 115K рядків коду, досвід у 10+ мережах. Колишній детектив. Лісабон.',
  meta_keywords:
  ...
  hero_subtitle: 'Експерт з автоматизації та AI-систем. Створюю автономні рішення на перетині Web3 та штучного інтелекту. Досвід у карному розшуку навчив мене бачити чітку архітектуру там, де інші бачать хаос.',
  hero_subtitle_lead: 'Експерт з автоматизації та AI-систем. Створюю автономні рішення на перетині Web3 та штучного інтелекту. Досвід у карному розшуку навчив мене бачити чітку архітектуру там, де інші бачать хаос.',
  hero_subtitle_body: '',
  hero_bio: '',
  ...
  about_text_1: "Мій підхід до розробки базується на логіці розслідувань: я знаходжу неефективності в бізнес-процесах і усуваю їх за допомогою коду. Сьогодні я поєдную роботу в IT-компанії з розробкою власних мультиагентних AI-систем.",
  about_text_2: 'Я занурився повністю: on-chain аналітика, створення ботів для NFT-мінтингу, CEX/DEX арбітраж, пошук вразливостей. Це швидко переросло у щось більше — почав виконувати замовлення для товаришів та колег по цеху.',
  about_text_3: '',
  about_text_4: '',
  ...
  exp_ai_desc: 'Розробка мультиагентних AI-систем, автоматизація створення контенту та управління соцмережами, впровадження Claude/Gemini.',
  ...
  exp_dev_desc: 'Розробка та підтримка промислових (production) систем, автоматизація бізнес-процесів, адміністрування серверів та баз даних.',
  ...
  exp_official_desc: 'Розробка та підтримка промислових (production) систем, автоматизація бізнес-процесів, адміністрування серверів та баз даних.',
  exp_official_b1: 'Розробка та підтримка промислових (production) систем',
  ...
  exp_ai_dev_desc: 'Розробка мультиагентних AI-систем, автоматизація створення контенту та управління соцмережами, впровадження Claude/Gemini.',
  exp_ai_dev_b1: 'Оркестрація системи з 11 AI-агентів для глибокої обробки даних',
  exp_ai_dev_b2: 'Автоматизація контенту та аналітики соцмереж',
  exp_ai_dev_b3: 'Інтеграція моделей Claude, Gemini та архітектури MCP-серверів',
  ...
  services_medical_examples: 'Що я можу зробити:|Інтелектуальний бот для запису на прийом до потрібного лікаря|Автоматичні нагадування пацієнтам про візит для зменшення неявок|AI-асистент для відповідей на поширені запитання про послуги та підготовку',
  ...
  services_hotels_examples: 'Що я можу зробити:|Багатомовний AI-консьєрж для відповіді на запитання гостей 24/7|Система моніторингу відгуків, що миттєво сповіщає про нові коментарі|Автоматизація комунікації з персоналом (сповіщення про прибирання)',
