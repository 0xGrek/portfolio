export const ua = {
  // ── Meta ──────────────────────────────────────────────
  meta_title: 'Сергій Іваненко — Web3 та AI-інженер з автоматизації',
  meta_description:
  ...
  about_p1:
    '5 років я працював у правоохоронних органах України, зокрема отримав сертифікат КОРДу за програмою за підтримки Посольства США. У 2022 році залишив поліцію і почав самостійно вчити програмування — HTML, CSS, JavaScript, потім Python і TypeScript. Без буткемпів, без IT-освіти. У березні 2023 я вже працював у Web3 на повний час.',
  about_p2:
    'З березня 2023 я створив 101 інструмент автоматизації на 10+ блокчейнах — усе до ери AI-кодингу. Найбільший проєкт — TON Gift Flipper: мультиагентна торговельна система на 115 000 рядків коду, 4 паралельних боти, 400+ Pyrogram-сесій, інтеграція з 6 API маркетплейсів. Я знаю, як експлуатують протоколи, бо сам працював ончейн у масштабі — знаходив уразливості в Web3-казино, відстежував кластери гаманців, аналізував маніпуляції з токенами зсередини.',
  about_p3:
    'Зараз фокусуюсь на ончейн-аналітиці — відстеження гаманців, аналіз потоків токенів, дослідження експлойтів протоколів. Будую мультиагентні AI-системи та екосистеми Telegram-ботів. 6 продакшн-проєктів, усі робочі. Базуюся в Лісабоні. Готовий до релокації.',
  about_unique:
    '5 років у правоохоронних органах натренували розпізнавання патернів під тиском. 101 інструмент з нуля натренували інженерію без підстраховки. Ця комбінація — слідчий інстинкт плюс продакшн-код — не те, що зустрінеш у типовому резюме розробника.',
  ...
  proj_orchestrator_title: 'AI-оркестратор знань',
  proj_orchestrator_desc:
    'Мультиагентна система, що маршрутизує контент між 8 спеціалізованими AI-агентами через LLM-класифікацію. Tkinter-дашборд з відстеженням прогресу в реальному часі.',
  proj_orchestrator_long:
    'Система, яку я використовую щодня для управління власним інформаційним потоком. Контент надходить з Telegram-каналів і автоматично класифікується LLM-диспетчером в одну з 8 доменів спеціалізованих агентів: крипто-дослідження, ончейн-аналітика, арбітраж, кар\'єрна розвідка, AI-інструменти, ретродропи, цитати та загальні теми. Кожен агент має власну пам\'ять (MEMORY.md), базу знань та контекстне вікно. Побудовано на Claude CLI з кастомною логікою оркестрації.',
  ...
  proj_toolkit_desc:
    '101 інструмент автоматизації, побудований до епохи вайб-кодингу. Скрипти виведення з CEX (9 бірж), мультичейн генератори гаманців (6 чейнів), збирачі токенів (20+ EVM мереж), клеймери аірдропів та боти для фармінгу протоколів.',
  proj_toolkit_long:
    'Повний тулкіт, побудований між 2023 та 2024 роками — до того, як AI-кодинг зробив це простим. 101 інструмент у 13 категоріях: CEX API-автоматизація для Binance, OKX, Bybit, Bitget, CoinEx, Gate та інших; мультичейн генератори гаманців для EVM, Solana, Bitcoin (Taproot/BRC-20), TON, SUI та Aptos; збирачі токенів для 20+ EVM мереж; перевірники та клеймери прав на аірдропи; боти для минтингу NFT; снайперські скрипти для газових воєн; фармінг Solana-телефонів через ADB; браузерна автоматизація через ZennoPoster (21+ проєкт) та Browser Automation Studio. Реальна інженерія — не згенерований код.',
  ...
  edu_swat_title: 'Сертифікат — Поліцейська SWAT підготовка',
  edu_swat_school: 'Спеціальний підрозділ поліції КОРД, МВС України',
  edu_swat_period: 'Червень – Липень 2021',
  edu_swat_location: 'Київ, Україна',
  edu_swat_desc: 'Спеціалізована тактична підготовка. За підтримки Посольства США в Україні (ISLEA). Сертифікат №1381.',
  edu_swat_note: 'За підтримки Посольства США в Україні (ISLEA). Сертифікат №1381',
