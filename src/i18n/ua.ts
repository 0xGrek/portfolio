export const ua = {
  ...
  hero_subtitle: 'Експерт з автоматизації та AI-систем. Створюю автономні рішення на перетині Web3 та штучного інтелекту. Спеціалізуюсь на проєктуванні системної архітектури та автоматизації складних бізнес-процесів.',
