export const ua = {
  ...
  services_cta_desc: 'Виявляю процеси, які споживають зайві ресурси, і впроваджую мультиагентні AI-системи. Результат: скорочення витрат часу на рутину до 80% та масштабування операційних можливостей вашого бізнесу.',
