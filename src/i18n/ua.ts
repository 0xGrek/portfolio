export const ua = {
  ...
  about_p1: 'Мій підхід — це інженерна оптимізація: я знаходжу вузькі місця в бізнес-логіці та усуваю їх за допомогою коду. Сьогодні я фокусуюсь на розробці автономних AI-агентів, які замінюють рутинну роботу інтелектуальними алгоритмами.',
  ...
  exp_police_desc: 'Працював у складі спеціалізованих аналітичних груп над розв\'язанням критичних інцидентів. Спеціалізувався на швидкому розгортанні інструментів збору даних у польових умовах та управлінні ризиками в режимі реального часу.',
  ...
  exp_ai_dev_b3: '',
  exp_police_b1: 'Аналіз складних масивів даних та виявлення прихованих патернів',
  exp_police_b2: 'Побудова архітектури логічних зв\'язків для вирішення нестандартних кейсів',
  exp_police_b3: 'Використання OSINT-технологій для збору та структурування інформації',
