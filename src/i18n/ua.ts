export const ua = {
  ...
  hero_subtitle:
    'Колишній офіцер економічної безпеки, нині Web3-практик. 101 інструмент автоматизації на 10+ блокчейнах. Базуюсь у Лісабоні, відкритий до remote-можливостей по всьому світу.',
