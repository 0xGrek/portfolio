export const ua = {
  ...
  exp_ai_dev_desc: 'Розробка мультиагентних AI-систем, автоматизація створення контенту та впровадження Claude/Gemini.',
  exp_ai_dev_b1: 'Оркестрація системи з 11 AI-агентів для глибокої обробки даних.',
  exp_ai_dev_b2: 'Інтеграція моделей Claude, Gemini та архітектури MCP-серверів.',
  exp_ai_dev_b3: '',
