export const ua = {
  ...
  about_p1:
    'Розробник-самоук. Почав кодити у 2022 — спочатку курси Udemy, потім Web3-автоматизація з березня 2023. Без буткемпів, без IT-освіти. Будував усе з нуля: мінтинг, парсинг, ончейн-трекінг, мультиакаунтна інфраструктура на всіх мажорних блокчейнах — L1, L2.',
  about_p2:
  ...
  exp_police_desc: 'Три роки служби — патруль, кримінальне розслідування, спецпідрозділ.',
  exp_police_b1: 'По 1 року в кожному підрозділі. Сертифікація від Посольства США.',
