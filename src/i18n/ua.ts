export const ua = {
  ...
  about_text_1: "Мій бекграунд поєднує методи системного аналізу з досвіду в правоохоронних органах та глибоку технічну експертизу в AI та Web3. Я спеціалізуюсь на пошуку неефективностей та побудові автономних систем, які конвертують хаос у чіткі бізнес-результати.",
  ...
  about_text_3: 'Сьогодні я поєдную роль розробника ПЗ в IT-компанії з побудовою власних AI-систем. Логіка та сама, що й на початку: знайти, де бізнес втрачає час та гроші, і змусити технології працювати на результат.',
  about_text_4: '',
