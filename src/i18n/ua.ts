export const ua = {
  ...
  services_construction_desc: 'Автоматичний збір оголошень з 10+ порталів. Боти моніторингу цін з миттєвими сповіщеннями про нові об\'єкти. Виявлення шахрайських повторних розміщень.',
  ...
  services_finance_desc: 'Моніторинг транзакцій та виявлення аномалій. Автоматизована звітність та інструменти комплаєнсу. Дашборди ризик-скорингу з оповіщеннями в реальному часі.',

  services_ecommerce_title: 'Е-комерція та рітейл',
  services_ecommerce_desc: 'Telegram-боти для замовлень, оплат і підтримки клієнтів. Автоматичне порівняння цін конкурентів. Відстеження залишків і сповіщення про поповнення.',

  services_food_title: 'Їжа та сервіс',
  services_food_desc: 'Telegram-бот для замовлень з меню, оплатою і трекінгом доставки. Автоматизація запису з нагадуваннями клієнтам. Автопостинг у соцмережі з вашого каталогу.',

  services_marketing_title: 'Маркетинг та аналітика',
  services_marketing_desc: 'Парсинг соцмереж та аналіз конкурентів. Боти для лідогенерації та автоматичного аутрічу. Кастомні дашборди зі звітами, що оновлюються автоматично.',

  services_crypto_title: 'Крипто та Web3',
  services_crypto_desc: 'Моніторинг гаманців і системи сповіщень у реальному часі. DeFi-автоматизація, аірдроп-інструменти, ончейн-розслідування та форензика.',
  services_crypto_example: 'Побудовано: моніторинг 35 гаманців на ETH, Polygon, Solana',

  services_ai_title: 'AI та автоматизація',
  services_ai_desc: 'AI-чатботи для підтримки клієнтів будь-якою мовою. Обробка документів і вилучення даних з PDF, email, таблиць. Мультиагентні системи для складних бізнес-процесів.',

  services_telegram_title: 'Telegram-екосистема',
  services_telegram_desc: 'Кастомні Telegram-боти для будь-якого бізнесу. Управління каналом і автомодерація. Міні-додатки з інтеграцією оплат.',
