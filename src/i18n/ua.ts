export const ua = {
  ...
  hero_subtitle: 'Спеціаліст з автоматизації та AI. Створюю системи, які працюють за вас. Мій шлях: від карного розшуку до розробки AI-агентів. Я завжди там, де складні процеси можна спростити та автоматизувати. Голодний до навчання, рухаюсь по тренду, відкритий до викликів.',
  hero_bio: '',
