export const ua = {
  ...
  exp_dev_company: 'Oleksandr Andrianov Unipessoal LDA · Лісабон',
  ...
  exp_dev_b2: 'Клієнтська робота під NDA (без імен клієнтів): Web3-автоматизація — on-chain парсери, mint-боти, скрапери, wallet monitoring',
  ...
  exp_freelance_b1: 'Консалтинг з Web3 та ончейн-даних: моніторинг гаманців і транзакцій, ринкові сигнали та DeFi risk-аналіз в EVM та Solana',
  exp_freelance_b2: 'Створював Python-інструменти скрапінгу та аналітики для ринкової розвідки та моніторингу публічних даних',
  exp_freelance_b3: 'Оркестрував AI-агентів для обробки даних, автоматизації контенту та генерації щоденного digest з 500+ повідомлень',
  exp_freelance_b4: 'Спроєктував архітектуру LLM routing між спеціалізованими memory domains з використанням Anthropic Claude API',
  ...
  proj_mafia_long:
    'Продакшн PWA для проведення живих ігрових сесій «Мафія» з друзями. Ігровий рушій є детермінованим: 17 унікальних ролей у 3 фракціях та 16 карт артефактів, які по-різному змінюють стан гри. Стан у реальному часі синхронізується через Supabase, щоб кілька пристроїв могли брати участь одночасно. Симулятор Монте-Карло запускає 500+ симульованих ігор для перевірки балансу ролей перед випуском змін правил. Розгорнуто на Vercel з повною підтримкою офлайн-режиму PWA.',
  ...
  proj_bridge_title: 'bridge_client — бібліотека адаптерів cross-chain мостів',
  proj_bridge_desc:
    'Python-бібліотека, що уніфікує 3 cross-chain bridge провайдери за одним інтерфейсом-адаптером, задокументована для повторного використання.',
  proj_bridge_long:
    'Python-бібліотека, що уніфікує 3 cross-chain bridge провайдери (LI.FI, Mayan, CCTP) за одним спільним інтерфейсом-адаптером, тож код виклику не потребує provider-специфічної логіки. Задокументована архітектурним документом та integration guide, спроєктована так, щоб її могли підхопити інші інженери, а не тільки для внутрішнього використання.',
