export const ua = {
  ...
  about_p2:
    'До 2023 року я вже будував серйозну крипто-інфраструктуру: скрипти для виведення з CEX, мультичейн менеджери гаманців, боти для аірдропів, минтери NFT — 101 інструмент у 13 категоріях, ще до епохи AI-кодингу. Реальна інженерія, реальні задачі, реальні рішення.',
  about_p3:
