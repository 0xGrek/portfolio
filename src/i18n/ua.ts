export const ua = {
  ...
  hero_subtitle: 'Експерт з автоматизації та AI-систем. Створюю автономні рішення на стику Web3 та штучного інтелекту. Бекграунд у розслідуваннях навчив мене бачити архітектуру там, де інші бачать хаос.',
  hero_subtitle_lead: 'Експерт з автоматизації та AI-систем. Створюю автономні рішення на стику Web3 та штучного інтелекту. Бекграунд у розслідуваннях навчив мене бачити архітектуру там, де інші бачать хаос.',
  hero_subtitle_body: '',
  hero_bio: '',
