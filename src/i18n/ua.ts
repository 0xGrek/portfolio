export const ua = {
  ...
  hero_subtitle: 'Спеціаліст з автоматизації та AI. Створюю системи, які працюють за вас. Мій шлях: від карного розшуку до розробки AI-агентів. Голодний до навчання, рухаюсь по тренду, відкритий до викликів.',
  hero_subtitle_lead: 'Спеціаліст з автоматизації та AI. Створюю системи, які працюють за вас.',
  hero_subtitle_body: 'Мій шлях: від карного розшуку до розробки AI-агентів. Голодний до навчання, рухаюсь по тренду, відкритий до викликів.',
  hero_bio: '',
  ...
  about_text_1: "Мій шлях в IT почався не зі школи чи університету, а з правоохоронних органів. Встиг попрацювати в 3х різних структурах, які навчили мене головному: бачити патерни в хаосі, швидко приймати рішення та системно виправляти те, що не працює.",
  ...
  about_text_3: 'Я занурився повністю: on-chain аналітика, створення ботів для NFT-мінтингу, CEX/DEX арбітраж, пошук вразливостей. Це швидко переросло у щось більше — почав виконувати замовлення для товаришів та колег по цеху.',
