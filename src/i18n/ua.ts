export const ua = {
  ...
  services_construction_desc: 'Всі оголошення з 10+ порталів в одному місці, оновлення щогодини. Миттєве сповіщення, коли з\'являється підходящий об\'єкт — раніше за всіх. Дублікати і шахрайські оголошення позначаються автоматично.',
  ...
  services_ecommerce_desc: 'Клієнти замовляють, платять і отримують оновлення прямо в Telegram — без дзвінків вам. Знаєте ціни конкурентів до того, як виставляєте свої. Сповіщення, коли товар закінчується — до того, як стане проблемою.',

  services_food_title: 'Кондитерські, ресторани та салони',
  services_food_desc: 'Клієнти переглядають меню, роблять замовлення і платять у Telegram — навіть опівночі. Нагадування про запис відправляються автоматично — менше неявок. Денні спеціальні пропозиції публікуються в Instagram без вашої участі.',
  ...
  services_marketing_desc: 'Бачите, що саме публікують конкуренти, що у них працює, а що — ні. Нові ліди отримують відповідь автоматично, щойно проявили інтерес. Щотижня звіт приходить у вашу скриньку — ніхто його не готував вручну.',
