export const ua = {
  ...
  hero_subtitle: 'Експерт з автоматизації та AI-систем. Створюю автономні рішення на перетині Web3 та штучного інтелекту. Досвід у сфері розслідувань навчив мене виявляти приховані архітектури та патерни там, де інші бачать хаос.',
  hero_subtitle_lead: 'Експерт з автоматизації та AI-систем. Створюю автономні рішення на перетині Web3 та штучного інтелекту. Досвід у сфері розслідувань навчив мене виявляти приховані архітектури та патерни там, де інші бачать хаос.',
  hero_subtitle_body: '',
  hero_bio: '',
  ...
  about_text_2: 'Мій шлях у технології почався з аналітики в екстремальних умовах. Досвід роботи з критичними інцидентами та великими масивами неструктурованих даних сформував аналітичну стійкість: здатність приймати точні рішення в умовах високої невизначеності та дефіциту часу.',
  about_text_3: '',
  about_text_4: '',
  ...
  about_p2: 'Мій шлях у технології почався з аналітики в екстремальних умовах. Досвід роботи з критичними інцидентами та великими масивами неструктурованих даних сформував аналітичну стійкість: здатність приймати точні рішення в умовах високої невизначеності та дефіциту часу.',
  ...
  exp_police_desc: 'Виявлення аномалій у складних інформаційних потоках та проведення OSINT-досліджень. Створення алгоритмів для структурування хаотичних даних та побудова логічних ланцюжків для аналізу ризиків.',
  ...
  exp_ai_dev_b3: '',
  exp_police_b1: 'Аналіз великих масивів даних для виявлення аномалій',
  exp_police_b2: 'Використання методів OSINT для збору інформації',
  exp_police_b3: 'Побудова логічних схем та пошук взаємозв\'язків у критичних сценаріях',
