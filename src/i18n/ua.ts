export const ua = {
  ...
  about_text_2: 'Мій шлях в IT почався не зі школи чи університету, а з правоохоронних органів. Три роки в патрульній поліції та карному розшуку навчили мене головному: бачити патерни в хаосі, швидко приймати рішення та системно виправляти те, що не працює.',
  about_text_3: '',
  about_text_4: '',
  ...
  about_p1: 'Мій підхід до розробки базується на логіці розслідувань: я знаходжу неефективності в бізнес-процесах і усуваю їх за допомогою коду. Сьогодні я поєдную роботу в IT-компанії з розробкою власних мультиагентних AI-систем.',
  about_p2: 'Мій шлях в IT почався не зі школи чи університету, а з правоохоронних органів. Три роки в патрульній поліції та карному розшуку навчили мене головному: бачити патерни в хаосі, швидко приймати рішення та системно виправляти те, що не працює.',
  about_p3: 'Переїхавши до Лісабона, я побачив світ крипти — середовище, де можливостей для автоматизації безмежно. Це швидко переросло у власний бізнес та серйозні замовлення для Web3-проєктів.',
