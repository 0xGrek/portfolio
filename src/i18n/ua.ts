export const ua = {
  ...
  about_unique:
    '5 років у правоохоронних органах — кримінальне розслідування та оперативно-розшукова діяльність → розпізнавання патернів, яке напряму переноситься в ончейн-форензику.'
