export const ua = {
  ...
  about_p2: 'Мій шлях у технології почався з аналітики в екстремальних умовах. Робота з нестандартними кейсами та масивами неструктурованих даних навчила мене головному: приймати рішення в умовах високої невизначеності.',
