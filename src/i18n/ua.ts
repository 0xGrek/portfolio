export const ua = {
  ...
  meta_description:
    'Колишній офіцер економічної безпеки, нині Web3-практик. 101 інструмент автоматизації, крипто-форензика, AI-оркестрація. Базується в Лісабоні, Португалія.',
  meta_keywords:
  ...
  hero_subtitle:
    'Колишній офіцер економічної безпеки, нині Web3-практик. 115K рядків коду у торговій системі, 6 продакшн-проєктів, 10+ блокчейнів. Базуюсь у Лісабоні, відкритий до remote-можливостей по всьому світу.',
  ...
  about_p1:
    'Я починав у правоохоронній сфері та економічній безпеці — розслідував фінансові злочини і розумів, як зсередини працює шахрайство. У 2022 році перейшов у технології: самостійно вивчив все від HTML/CSS до Python, TypeScript і блокчейн-розробки.',
  about_p2:
    'З березня 2023 року я вже будував серйозну крипто-інфраструктуру: скрипти для виведення з CEX, мультичейн менеджери гаманців, боти для аірдропів, минтери NFT — 101 інструмент у 13 категоріях, ще до епохи AI-кодингу. Реальна інженерія, реальні задачі, реальні рішення.',
  about_p3:
    'Сьогодні я поєдную цю операційну глибину з AI-оркестрацією та ончейн-аналітикою. Будую мультиагентні системи, відстежую гаманці та токен-потоки, досліджую вразливості протоколів і допомагаю бізнесам автоматизувати те, що займає у людей години.',
  about_unique:
    'Що мене вирізняє: я побував з обох боків — як слідчий і як розробник. Такий подвійний досвід зустрічається рідко.',
