export const ua = {
  ...
  hero_subtitle:
    'Web3 білдер та інженер автоматизації. Торгова система на 115K рядків коду. 101 інструмент на 10+ блокчейнах. Самоучка з 2022 року. Лісабон, відкритий до пропозицій.',
  ...
  about_p1:
    'Я вивчав правоохоронну діяльність та економіку в університеті в Україні — це дало мені глибоке розуміння фінансових систем, шахрайства та розслідувань. Але я не пішов у поліцію. У 2022 році я самостійно навчився програмувати і одразу пішов у Web3.',
  about_p2:
  ...
  about_unique:
    'Правоохоронна освіта плюс Web3 інженерія. Я розумію і як системи ламають, і як їх будувати безпечно. Така перспектива — рідкість.',
