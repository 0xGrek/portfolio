export const es = {
  ...
  hero_subtitle: 'Experto en Automatización y Sistemas IA. Creo soluciones autónomas en la intersección de Web3 e inteligencia artificial. El background en investigación me enseñó a ver arquitectura donde otros ven caos.',
  hero_subtitle_lead: 'Experto en Automatización y Sistemas IA. Creo soluciones autónomas en la intersección de Web3 e inteligencia artificial. El background en investigación me enseñó a ver arquitectura donde otros ven caos.',
  hero_subtitle_body: '',
  hero_bio: '',
  ...
  about_text_1: "Mi background combina métodos de análisis sistemático de la experiencia en fuerzas del orden con profunda expertise técnica en AI y Web3. Me especializo en encontrar ineficiencias y construir sistemas autónomos que convierten el caos en resultados empresariales claros.",
  ...
  about_text_3: 'Hoy combino el rol de desarrollador de software en una empresa de IT con la construcción de mis propios sistemas de IA. La lógica es la misma desde el principio: encontrar dónde el negocio pierde tiempo y dinero, y hacer que la tecnología entregue resultados.',
  about_text_4: '',
  ...
  services_cta_desc: 'Identifico procesos que consumen recursos excesivos e implemento sistemas IA multi-agente. Resultado: reducción de hasta el 80% del tiempo en rutina y escalabilidad de las capacidades operativas de tu negocio.',
