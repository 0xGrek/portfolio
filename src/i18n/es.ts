export const es = {
  ...
  hero_subtitle: 'Experto en Automatización y Sistemas IA. Creo soluciones autónomas en la intersección de Web3 e inteligencia artificial. Me especializo en el diseño de arquitectura de sistemas y la automatización de procesos empresariales complejos.',
  hero_subtitle_lead: 'Experto en Automatización y Sistemas IA. Creo soluciones autónomas en la intersección de Web3 e inteligencia artificial. Me especializo en el diseño de arquitectura de sistemas y la automatización de procesos empresariales complejos.',
  hero_subtitle_body: '',
  hero_bio: '',
  ...
  exp_police_title: 'Especialista en Análisis de Datos e Investigación de Sistemas',
  ...
  exp_crypto_auto_title: 'Crypto y Automatización',
  exp_crypto_auto_company: 'Autónomo',
  exp_crypto_auto_period: '2023 – Presente',
  exp_crypto_auto_location: 'Portugal',
  exp_crypto_auto_desc: 'Construcción de soluciones complejas en Web3, IA y automatización empresarial.',
  exp_crypto_auto_b1: 'Construyó escáneres crypto y monitoreo de billeteras',
  exp_crypto_auto_b2: 'Automatizó estrategias DeFi y operaciones de trading',
  exp_crypto_auto_b3: 'Análisis on-chain y rastreo de transacciones',
  exp_ai_dev_title: 'Desarrollador IA',
  exp_ai_dev_company: 'Autónomo',
  exp_ai_dev_period: '2026 – Presente',
  exp_ai_dev_location: 'Portugal',
  exp_ai_dev_desc: 'Sistemas IA multi-agente, automatización de contenido y redes sociales, integración Claude/Gemini.',
  exp_ai_dev_b1: 'Orquestación de 11 agentes IA para procesamiento de datos',
  exp_ai_dev_b2: 'Automatización de contenido y análisis de redes sociales',
  exp_ai_dev_b3: 'Integración Claude, Gemini, servidores MCP',
  exp_police_b1: 'Análisis de conjuntos de datos complejos y detección de patrones ocultos',
  exp_police_b2: 'Construcción de arquitecturas de conexiones lógicas para resolver casos no estándar',
  exp_police_b3: 'Aplicación de técnicas OSINT para recopilación y estructuración de información',
