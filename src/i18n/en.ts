export const en = {
  ...
  hero_subtitle:
    'Former economic security officer turned Web3 practitioner. 101 automation tools across 10+ blockchains. Based in Lisbon, open to remote opportunities worldwide.',
