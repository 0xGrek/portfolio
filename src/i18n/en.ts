export const en = {
  ...
  hero_subtitle: "Automation & AI Systems Expert. I build autonomous solutions at the intersection of Web3 and artificial intelligence. An investigative background taught me to see architecture where others see chaos.",
  hero_subtitle_lead: "Automation & AI Systems Expert. I build autonomous solutions at the intersection of Web3 and artificial intelligence. An investigative background taught me to see architecture where others see chaos.",
  hero_subtitle_body: "",
  hero_bio: '',
  ...
  hero_location: '📍 Lisbon, Portugal — UTC+1 (WET)',
  ...
  exp_police_desc: 'Focus on unstructured data and pattern analysis. Experience that developed analytical skills and the ability to find solutions in non-standard situations.',
  ...
  exp_crypto_auto_title: 'Crypto & Automation',
  exp_crypto_auto_company: 'Sole Proprietor',
  exp_crypto_auto_period: '2023 – Present',
  exp_crypto_auto_location: 'Portugal',
  exp_crypto_auto_desc: 'Building complex solutions in Web3, AI and business automation.',
  exp_crypto_auto_b1: 'Built crypto scanners and wallet monitoring',
  exp_crypto_auto_b2: 'Automated DeFi strategies and trading operations',
  exp_crypto_auto_b3: 'On-chain analytics and transaction tracking',
  exp_ai_dev_title: 'AI Developer',
  exp_ai_dev_company: 'Sole Proprietor',
  exp_ai_dev_period: '2026 – Present',
  exp_ai_dev_location: 'Portugal',
  exp_ai_dev_desc: 'Multi-agent AI systems, content and social media automation, Claude/Gemini integration.',
  exp_ai_dev_b1: 'Orchestrating 11 AI agents for data processing',
  exp_ai_dev_b2: 'Content and social media analytics automation',
  exp_ai_dev_b3: 'Claude, Gemini, MCP servers integration',
  exp_police_b1: 'Patrol Police (2019) → Criminal Investigation (2020) → Special Unit (2021)',
  exp_police_b2: '',
  exp_police_b3: '',
